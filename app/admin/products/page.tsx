...
export default async function ProductsAdminPage() {
  ...
  return (
  <main className="min-h-screen bg-muted/30 dark:bg-[#020617] p-6 transition-colors">
          ...
          <CardContent className="flex flex-col items-center justify-center py-20 text-center">
            <div
              className="
                ...
                justify-center rounded-2xl bg-muted

                dark:bg-zinc-800
              "
            >
              <Package2 className="h-8 w-8 text-muted-foreground dark:text-zinc-400" />
            </div>
            ...
            <p className="mt-2 max-w-md text-sm text-muted-foreground dark:text-zinc-400">
              Start building your
